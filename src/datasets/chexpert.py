"""
CheXpert Dataset. Adapted from
https://github.com/dongkyunk/CheXFusion/blob/main/dataset/chexpert_dataset.py
"""
...
class ChexpertDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        path = Path(f"{self.cfg['data_dir']}/chexpert/{self.df.iloc[index]['Path']}")
